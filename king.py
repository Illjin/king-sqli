...
if extension == "site:":
     ...
     for j in search(query, tld="com", num=total_output, stop=total_output, pause=pause_random):
...
def dorks_google():
    dorks_google = "https://www.google.com/search?q="+"inurl:php?id="+"site:gov.za"+"&start="+str(page_no)
    return dorks_google
...
## Create an outut with all vulnerable sites to sqli
def output():
